...
func main() {
	...
	sudoku.Mark(3, 4)
	sudoku.Print()
	fmt.Println(sudoku.IsPlacementValid(3, 4, 6)) // Should be invalid
	fmt.Println(sudoku.IsPlacementValid(3, 4, 5)) // Should be invalid
	fmt.Println(sudoku.IsPlacementValid(3, 4, 4)) // Should be valid
	fmt.Println(sudoku.IsPlacementValid(3, 4, 9)) // Should be invalid
